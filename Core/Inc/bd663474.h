...
#define D_CS_GPIO_Port			GPIOB       //D5 =>PB4 (CS)
#define D_CS_Pin				GPIO_PIN_12
#define D_RS_GPIO_Port			GPIOC       //D0  =>PA3 (RS)
#define D_RS_Pin				GPIO_PIN_6
#define	RESET_GPIO_Port			GPIOC       //D1  =>PA2(RESET)
#define	RESET_Pin				GPIO_PIN_8

//#define D_CS_GPIO_Port			GPIOB       //D10 =>PB6 (CS)
//#define D_CS_Pin				GPIO_PIN_6
//#define D_RS_GPIO_Port			GPIOA       //D7  =>PA8 (RS)
//#define D_RS_Pin				GPIO_PIN_8
//#define	RESET_GPIO_Port			GPIOB       //D4  =>PB4(RESET)
...
enum COLOR{
	...
	TFT_COLOR_Green_Light1       = TFT_RGB(0, 200, 0),
	TFT_COLOR_Green_Light       = TFT_RGB(0, 255, 0),
